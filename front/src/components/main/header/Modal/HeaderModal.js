                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td headers="gmenu gmenu2">
                                        <ul style={{paddingInlineStart: '0px'}}>
                                            <li><a href='http://1localhost:3000/sallybox/movied/1' title="현재상영작" tabIndex="0">현재상영작</a></li>
                                ...
                                <tr>
                                    <td headers="gmenu gmenu7">
                                        <ul style={{paddingInlineStart: '0px'}}>
                                            <li><a href={ userId ?
                                                (`http://localhost:3000/sallybox/mypage/${userId}`)
                                                : (`http://localhost:3000/sallybox/sign-in`)
                                                } 
